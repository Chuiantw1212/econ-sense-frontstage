<template>
	<div class="container pb-5">
		<MyPageHeader :src="imageUrl" name_zh="朱奕安" name_en="(Ian Chu)">
			<img alt="myAvatar" src="https://storage.googleapis.com/my-blog-287510.appspot.com/myAvatar.png" />
		</MyPageHeader>
		<Card class="my-social">
			...
			<div class="row justify-content-center p-2">
				<h6 class="col-12 font-weight-bold">美國東北大學Informatics (GPA:3.71)</h6>
				<h6 class="col-12 font-weight-bold">金融專精網頁工程師/ 手作愛好者</h6>
		...
		<MyTheme title="獨立開發">
			...
			<Card class="col-md-6 col-lg-4 mt-3">
				...
				<p>在Ladies, Wind & Design的活動上結識, 答應要幫他做一個協助轉職的網頁</p>
			</Card>
			<Card class="col-md-6 col-lg-4 mt-3">
				<img alt="work-designer" src="https://storage.googleapis.com/deedoo-material/work-designer.png" />
				<h3>
					<a
			...
			<div class="col-11">
					...
					<ul>
						<li>
							...
							<ul>
								<li>
									從崩潰邊緣拉起
									<a href="https://www.fundrich.com.tw/" target="_blank" rel="noopener">基富通</a>好享退專案
								</li>
								<li>
									協助
									<a
				...
				<MyListItem>
					...
					<ul>
						...
						<li>義務役政戰預官</li>
						<li>國立中興大學資工系(GPA:2.51)(期末專題第二)(ITSA全國大專院校軟體創意競賽銅牌獎)</li>
					</ul>
				</MyListItem>
			</div>
			<div class="col">
